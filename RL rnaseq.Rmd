...
topTags(qlf, n=Inf, sort.by = "logFC")
```
...
```
Genes that respond to disp. at any temp or stage compared to mock+parisii
```{r}
...
sanity check again
```{r}
x$counts["WBGene00044237",]
x$counts["WBGene00010821",]
x$counts["WBGene00013130",]
```
